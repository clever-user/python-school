...
Python рядки є [immutable](https://docs.python.org/3/glossary.html#term-immutable).
...
Зрізи, це  дуже просто. Це просто означає, що ви отримаєте частину рядка.
Наприклад, щоб отримати всі символи між другим і п'ятим  символами, ми можемо зробити наступне:
...
Отже синтаксис схожий `some_string[start:end]`.
